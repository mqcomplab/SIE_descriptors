# This script generates multiple statistal analysis tables for fitting anions using all 16 formulas and all 9 properties.
...
property_list = property_list = ["dG", "dH", "viscosity", "diffusion", "gfet", "dlcst", "sn2", "activity", "lysozyme"]
charge = -1
...
print(f'Finished in {round(end-start,2)} seconds') # 271s on gpu desktop.